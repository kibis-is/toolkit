import { GenIcon, type IconBaseProps, type IconType } from 'react-icons';

const KbVoi: IconType = (props: IconBaseProps) =>
  GenIcon({
    tag: 'svg',
    attr: {
      viewBox: '0 0 38.231651 34.998402',
    },
    child: [
      {
        tag: 'path',
